                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <div
                            className={`h-10 w-10 rounded-lg grid place-items-center ${pass
                        ...
                        <div className="text-right">
                          ...
                          <p
                            className={`text-xs font-semibold ${pass ? "text-emerald-700" : "text-red-700"
                              }`}
                          >
                            {pct}% {pass ? "Pass" : "Fail"}
                          </p>
              ...
              <div className="px-6 py-4 space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full h-11 rounded-lg border px-3 outline-none focus:ring-2
                      ${!touched || nameValid ? "border-gray-300/70 focus:ring-[#2E5EAA]/30" : "border-red-300 focus:ring-red-200"}`}
                  />
                  {!nameValid && touched && (
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full h-11 rounded-lg border px-3 outline-none focus:ring-2
                      ${!touched || seatValid ? "border-gray-300/70 focus:ring-[#2E5EAA]/30" : "border-red-300 focus:ring-red-200"}`}
                  />
                  {!seatValid && touched && (
                    <p className="mt-1 text-xs text-red-600">Seat format must match B + 11</p>
                  )}
                </div>
              </div>
